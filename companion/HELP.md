...
8. Connection Variables - Create connection variables for all cached OIDs, they will be polled each interval. Compared to the OID Value feedback, `OctetString` and `Opaque` VarBind encoding is fixed to utf8 and numeric values have a fixed factor of 1.
